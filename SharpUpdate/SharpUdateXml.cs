...
namespace SharpUpdate
{
    internal class SharpUdateXml
    {
        ...
        internal SharpUdateXml(Version version, Uri uri, string fileName, string md5, string description, string launchArgs)
        {
        ...
        internal static SharpUdateXml Parse(Uri location, string appID)
        {
            ...
            try
            {
                ...
                return new SharpUdateXml(version, new Uri(url), fileName, md5, description, launchArgs);
            }
            catch{ return null; }
        }
    }
